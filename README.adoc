...
$ oc create -f https://raw.githubusercontent.com/tariq-islam/aloha/master/custom-jenkins.build.yaml
...
$ oc new-app -p MEMORY_LIMIT=1024Mi https://raw.githubusercontent.com/tariq-islam/aloha/master/jenkins-ephemeral-template.json
