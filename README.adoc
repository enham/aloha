...
$ oc create -f https://raw.githubusercontent.com/tariq-islam/aloha/bluegreen/custom-jenkins.build.yaml
...
$ oc new-app -p MEMORY_LIMIT=1024Mi https://raw.githubusercontent.com/tariq-islam/aloha/bluegreen/jenkins-ephemeral-template.json
